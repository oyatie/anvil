...
mod tests {
    ...
    fn test_stage_fallback_chains_have_multiple_tiers() {
        // Recon has 4 tiers
        let recon = get_stage_fallback_chain(AgenticStage::Recon);
        ...
        let plan = get_stage_fallback_chain(AgenticStage::Planning);
        ...
        let plan_rev = get_stage_fallback_chain(AgenticStage::PlanReview);
        ...
        let impl_stage = get_stage_fallback_chain(AgenticStage::Implementation);
        ...
        let code_rev = get_stage_fallback_chain(AgenticStage::CodeReviewAudit);
