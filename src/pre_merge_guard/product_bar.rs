...
//! already receive — and makes no network or filesystem call. That last claim
//! is not decoration: `the_verdict_depends_on_nothing_but_the_change_it_was_handed`
...
pub fn missing_artifacts(pr_title: &str, pr_body: &str) -> Vec<Artifact> {
