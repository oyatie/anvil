...
fn neutral_guard_reports() -> NeutralGuardReports {
    ...
    NeutralGuardReports {
        ...
        compliance: anvil::compliance_guard::ComplianceGuardReport {
            ...
            statutes_evaluated: Vec::new(),
            active_rules_count: 0,
            rules_loaded_from_pack: 0,
            pack_rules_rejected: Vec::new(),
        ...
        adr: anvil::adr_drift_ratchet::AdrReport {
            status: anvil::pre_merge_guard::report::GateStatus::Passed,
            is_compliant: true,
            adrs_evaluated: 0,
            required_fields: Vec::new(),
            architectural_changes_without_adr: Vec::new(),
            violations: Vec::new(),
            summary: n(),
        },
        shuffle: anvil::shuffle_shard_simulator::ShuffleShardReport {
